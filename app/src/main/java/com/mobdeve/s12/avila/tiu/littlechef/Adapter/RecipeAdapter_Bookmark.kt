...
class RecipeAdapter_Bookmark() : RecyclerView.Adapter<RecipeAdapter_Bookmark.HolderRecord>() {
    ...
    inner class HolderRecord(itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        //views from row_recipe_bookmark.xml
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HolderRecord {
        ...
        return HolderRecord(
            LayoutInflater.from(context).inflate(R.layout.row_recipe_bookmark, parent, false)
        )
    }
    ...
    override fun onBindViewHolder(holder: HolderRecord, position: Int) {
        ...
        } else if (image == "recipe6") {
            holder.ivImage.setImageResource(R.drawable.recipe6)
        } else if (image == "recipe7") {
            holder.ivImage.setImageResource(R.drawable.recipe7)
        } else if (image == "recipe8") {
            holder.ivImage.setImageResource(R.drawable.recipe8)
        } else if (image == "recipe9") {
            holder.ivImage.setImageResource(R.drawable.recipe9)
        } else if (image == "recipe10") {
            holder.ivImage.setImageResource(R.drawable.recipe10)
        }else {
